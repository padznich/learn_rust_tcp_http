...
impl From<String> for HttpRequest {
    fn from(req: String) -> Self {
        ...
        let mut parsed_resource = Resource::Path("".to_string()); let mut parsed_headers = HashMap::new();
        ...
        for line in req.lines() {
            ...
            if line.contains("HTTP") {
                let (method, resource, version) = process_req_line(line); parsed_method = method;
